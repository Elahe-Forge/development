...
def handler(event, context):
    for record in event['Records']: 
        ...
        issuer = record['dynamodb']['NewImage']['issuer']['S']
        news_date = record['dynamodb']['NewImage']['news_date']['S']
        news_title = record['dynamodb']['NewImage']['news_title']['S']
        news_source = record['dynamodb']['NewImage']['news_source']['S']
        news_url = record['dynamodb']['NewImage']['news_url']['S']
